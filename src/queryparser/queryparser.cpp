...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_STRNAME = 3,                    /* STRNAME  */
  YYSYMBOL_KEY_AND = 4,                    /* KEY_AND  */
  YYSYMBOL_KEY_OR = 5,                     /* KEY_OR  */
  YYSYMBOL_6_ = 6,                         /* '('  */
  YYSYMBOL_7_ = 7,                         /* ')'  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_input = 9,                      /* input  */
  YYSYMBOL_10_expr_or_null = 10,           /* expr-or-null  */
  YYSYMBOL_expr = 11,                      /* expr  */
  YYSYMBOL_12_expr_no_pt = 12,             /* expr-no-pt  */
  YYSYMBOL_13_expr_and = 13,               /* expr-and  */
  YYSYMBOL_14_expr_or = 14,                /* expr-or  */
  YYSYMBOL_15_name_no_pt = 15              /* name-no-pt  */
};
...
# define YYCOPY_NEEDED 1
     ...
     && (! defined __cplusplus \
         || (defined XYLTYPE_IS_TRIVIAL && XYLTYPE_IS_TRIVIAL \
             && defined XYSTYPE_IS_TRIVIAL && XYSTYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "STRNAME", "KEY_AND",
  "KEY_OR", "'('", "')'", "$accept", "input", "expr-or-null", "expr",
  "expr-no-pt", "expr-and", "expr-or", "name-no-pt", YY_NULLPTR
};
...
{
       4,    13,     0,     0,     2,     3,     6,     9,    10,     8,
       0,     6,     8,     1,     0,     0,     5,     7,    11,    12
};
...
#define yyclearin       (yychar = XYEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use XYerror or XYUNDEF. */
#define YYERRCODE XYUNDEF
...
#  elif defined XYLTYPE_IS_TRIVIAL && XYLTYPE_IS_TRIVIAL
...
YYLTYPE yylloc
# if defined XYLTYPE_IS_TRIVIAL && XYLTYPE_IS_TRIVIAL
  = { 1, 1, 1, 1 }
# endif
;
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N), yylsp -= (N))
  ...
  yychar = XYEMPTY; /* Cause a token to be read.  */
...
#line 105 "src/queryparser/queryparser.y"
    ...
    std::regex e2("[!a-zA-Z]{1}[\\w.]*");
    std::regex e3("[a-zA-Z]{1}[\\w.]*");
    std::regex num("[0-9]+");

    if ((aux.find(ocl_equal) == std::string::npos) &&
        (aux.find(ocl_different) == std::string::npos) &&
        (aux.find(spaced_ocl_in) == std::string::npos) &&
        (aux.find(ocl_gt) == std::string::npos) &&
        (aux.find(ocl_lt) == std::string::npos) &&
        (aux.find(ocl_geq) == std::string::npos) &&
        (aux.find(ocl_leq) == std::string::npos)) {
...
yyerrlab:
  ...
  yytoken = yychar == XYEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
